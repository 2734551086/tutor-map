...
// ─── Migrate legacy grade aliases → canonical (keeps old DBs consistent) ─────
const GRADE_ALIAS = {
...
const migrateGrades = db.transaction(() => {
  for (const [alias, canonical] of Object.entries(GRADE_ALIAS)) {
    db.prepare('UPDATE requests SET grade = ? WHERE grade = ?').run(canonical, alias)
  }
})
migrateGrades()
...
if (count.c === 0) {
  ...
  const seedData = [
    // 【武昌区 - 光谷广场】
    ['高中一年级数学三角函数薄弱，想提分', '数学', '高中一年级', '期中数学68分，三角函数和函数概念理解困难，做题慢', '每周六下午2-4点，可长期', '重点大学数学专业在读或毕业，有耐心，女老师优先', 120, 180, '光谷广场 珞喻路889号', 30.505, 114.403],
    // 【洪山区 - 街道口】
    ['小学六年级英语小升初冲刺', '英语', '小学六年级', '英语基础尚可但听力口语弱，希望集中提升', '暑假每天上午9-11点，连续3周', '英语专业优先，发音标准，有小学教学经验', 100, 150, '街道口 珞狮路 群光广场', 30.523, 114.352],
    // 【武昌区 - 武汉大学附近】
    ['初中三年级物理中考冲刺', '物理', '初中三年级', '物理力学电学基础薄弱，月考72分，目标中考95+', '每周日全天可调配，周三晚上7-9点', '理工科大学生或物理专业，熟悉中考考点', 150, 220, '武大 珞珈山 茶港小区', 30.541, 114.361],
    // 【洪山区 - 光谷软件园】
    ['小学二年级语文阅读写作', '语文', '小学二年级', '识字量低于同龄，不爱阅读，需趣味引导', '周二、周四下午4:30-6:00', '师范类女生，性格活泼有亲和力', 80, 120, '光谷软件园 关山大道', 30.492, 114.402],
    // 【江夏区 - 藏龙岛】
    ['高中二年级化学选考提升', '化学', '高中二年级', '化学选考，有机化学部分薄弱，希望系统梳理知识点', '每周五晚7-9点、周六下午', '化学相关专业，有选考教学经验', 200, 300, '藏龙岛 湖北经济学院旁', 30.401, 114.383],
    // 【东湖高新区 - 未来科技城】
    ['小学一年级奥数思维启蒙', '数学', '小学一年级', '孩子对数学有兴趣，想系统学习奥数思维', '每周三、周六各1.5小时', '有奥数教学经验，童趣活泼', 100, 150, '未来科技城 光谷七路', 30.492, 114.518],
    // 【武昌区 - 楚河汉街】
    ['初中三年级英语口语强化', '英语', '初中三年级', '口语表达弱，中考听说考试需要系统训练', '周一、周五晚6:30-8:00', '英语口语流利，有留学背景优先', 180, 250, '楚河汉街 万达广场', 30.554, 114.336],
    // 【东西湖区 - 金银湖】
    ['小学五年级数学应用题专项', '数学', '小学五年级', '应用题理解能力弱，审题不清', '周六上午9-11点', '数学教育专业优先，讲解清晰', 90, 130, '金银湖 万科四季花城', 30.643, 114.211],
    // 【武昌区 - 中南路】
    ['高中三年级物理专题复习', '物理', '高中三年级', '高考物理目标90+，电磁感应大题失分严重', '每周六下午、周日上午', '重点大学物理专业，熟悉近三年高考题型', 250, 350, '中南路 财神广场', 30.536, 114.329],
    // 【江岸区 - 百步亭】
    ['小学四年级语文作文提升', '语文', '小学四年级', '作文流水账，缺乏细节描写能力', '每周日下午2-4点', '汉语言文学专业，有作文教学经验', 100, 140, '百步亭花园 温馨苑', 30.653, 114.333],
    // 【洪山区 - 关山大道大学园路】
    ['初中一年级数学+英语同步辅导', '数学', '初中一年级', '小升初后成绩下滑，需要全科辅导', '周一至周五晚6-8点（可选2-3天）', '师范类或理工科在校生，认真负责', 130, 180, '关山大道 华科园', 30.489, 114.405],
    // 【汉阳区 - 王家湾】
    ...
    // 【黄陂区 - 盘龙城】
    ['高中三年级英语读写冲刺', '英语', '高中三年级', '阅读理解和写作丢分多，高考冲刺', '寒假期间每天上午', '英语专业研究生优先，有高考辅导经验', 220, 300, '盘龙城 奥特莱斯', 30.693, 114.267],
    // 【江汉区 - 汉口火车站附近】
    ['钢琴陪练（每周2次）', '其他', '小学三年级', '学琴2年，需要陪练纠错', '周二、周五晚7-8:30', '钢琴十级或音乐专业，耐心细致', 100, 150, '汉口火车站 后襄河', 30.622, 114.257],
    // 【洪山区 - 南湖】
    ['高中一年级物理+数学', '物理', '高中一年级', '中考后成绩中等，希望稳中提升', '每周六下午2-6点', '理科强的大学生，讲课生动', 140, 200, '南湖 保利心语', 30.479, 114.350],
    // 【武昌区 - 积玉桥】
